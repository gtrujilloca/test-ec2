document.getElementById('encender-btn').addEventListener('click', async () => {
    try {
        const response = await fetch('https://g43fzqmndshvc7wxdaqxwfdjuu0hhvmx.lambda-url.us-east-1.on.aws/', {
            method: 'POST',
            headers: {
